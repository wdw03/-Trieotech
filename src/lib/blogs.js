...
export function normalizeBlog(b) {
  ...
  return {
    ...
    imageAlt: b.image_alt || b.imageAlt || b.title || '',
...
export async function createBlog(data) {
  ...
  const blogPayload = {
    ...
    image_alt: data.imageAlt || data.image_alt || title || '',
...
export async function updateBlog(slugOrId, data) {
  ...
  const updatePayload = {
    ...
    ...((data.imageAlt !== undefined || data.image_alt !== undefined) ? { image_alt: data.imageAlt ?? data.image_alt } : {}),
