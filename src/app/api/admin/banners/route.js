...
export async function POST(request) {
  try {
    ...
    const payload = {
      ...
      desktop_image: (body.desktop_image || body.desktopImage || body.image || '/hero/desktop-banner.jpg').trim(),
      mobile_image: (body.mobile_image || body.mobileImage || body.desktop_image || body.image || '/hero/mobile-banner.jpg').trim(),
