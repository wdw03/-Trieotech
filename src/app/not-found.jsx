    ...
    <div className="min-h-[75vh] flex items-center justify-center px-4 py-16 text-center">
      <div className="ethnic-card max-w-lg w-full p-8 sm:p-12 rounded-3xl space-y-6 shadow-2xl border-2 border-gold-500/30">
        ...
        <div className="flex items-center justify-center gap-3 pt-2">
          <Link href="/" className="btn-primary py-2.5 px-6 text-xs font-bold uppercase tracking-wider flex items-center gap-1.5">
            <Home className="w-4 h-4" />
            <span>Return Home</span>
          </Link>
          <Link href="/shop" className="btn-outline-maroon py-2.5 px-6 text-xs font-bold uppercase tracking-wider flex items-center gap-1.5">
