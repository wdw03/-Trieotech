    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6 space-y-8">
      ...
      <div className="relative rounded-3xl overflow-hidden p-8 sm:p-12 bg-gradient-to-r from-maroon-950 via-maroon-900 to-[#1F0C0C] text-white border border-gold-500/30 shadow-xl">
        ...
        <div className="relative z-10 max-w-2xl space-y-3">
          ...
          <p className="text-xs sm:text-sm text-stone-300 font-normal max-w-lg">
          ...
          <div className="relative max-w-sm pt-2">
            ...
            <input
              ...
              className="w-full pl-9 pr-4 py-2.5 bg-white/5 border border-gold-500/20 rounded-xl text-xs text-ivory-100 placeholder:text-stone-500 outline-none focus:border-gold-400/50 backdrop-blur-sm"
            />
          </div>
        </div>
      </div>
      ...
      {featuredBlog && (
        <Link
          ...
          className="block ethnic-card rounded-3xl overflow-hidden group hover:border-gold-500/50 transition-all duration-300 transform hover:-translate-y-1"
        >
          <div className="grid grid-cols-1 md:grid-cols-2 gap-0">
            <div className="aspect-[16/10] md:aspect-auto overflow-hidden bg-stone-100 dark:bg-stone-900 relative">
              <img
            ...
            <div className="p-6 sm:p-8 flex flex-col justify-center space-y-4">
              ...
              <h2 className="font-serif font-bold text-lg sm:text-2xl text-stone-900 dark:text-ivory-100 group-hover:text-maroon-700 dark:group-hover:text-gold-400 transition-colors leading-snug">
                {featuredBlog.title}
              </h2>
              ...
              <div className="flex items-center justify-between pt-2">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <span className="text-xs font-bold text-stone-900 dark:text-ivory-100 block leading-none">{featuredBlog.author}</span>
                    <span className="text-[10px] text-stone-400">{featuredBlog.authorRole || featuredBlog.author_role}</span>
                  </div>
                </div>
                ...
                <div className="pt-4 border-t border-gold-500/10 flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      <span className="text-[10px] text-stone-400">{blog.authorRole || blog.author_role}</span>
                    </div>
                  </div>
                  <span className="text-xs font-bold text-maroon-700 dark:text-gold-400 group-hover:translate-x-1 transition-transform inline-flex items-center gap-1">
                    Read Article →
